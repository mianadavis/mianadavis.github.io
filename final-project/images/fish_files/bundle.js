...
OT.Common.Helpers.navigate = (function ($, $window) {
  ...
  function buildR3QueryString(r3QueryString, r3uid, ref, ot_source, ot_campaign, colorId, dark, controlGroup) {
    var params = {};
    ...
    if (controlGroup === '0' || controlGroup === '1') {
  ...
  function navigate(options) {
    ...
    var controlGroup = options.controlGroup;

    if (rid <= 0) {
      return;
    }

    r3QueryString = buildR3QueryString(r3QueryString, r3uid, ref, ot_source, ot_campaign, colorId, dark, controlGroup);
...
OT.Widget.Init = (function($, moment, $window, $document, undefined) {
  var firstRid, searchHost, searchPath, insideIframe, lang, useModal, r3uid, ot_campaign, ot_source, ref, colorId, dark, controlGroup;
  ...
  var bindSearchOptions = function(options){
    if (options){
      ...
      controlGroup = options.controlGroup;
    }
  };
